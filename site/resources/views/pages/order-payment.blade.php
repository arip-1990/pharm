...
@section('content')
    ...
    <div class="page">
        ...
        <p>В случае возникновении проблем с оплатой, Вы можете обратиться за поддержкой по номеру <span class="fw-bold">+7 (928) 984-44-68</span>,</p>
        <p>либо обратиться в единую справочную сети <span class="fw-bold">+7 (8722) 606-366</span></p>
