  ...
  return (
    ...
    >
      ...
      <Page title="Программа лояльности">
        <span>
          Получите бонусную карту <b>бесплатно</b> при любой покупке в аптеке
          или регистрации на сайте и в мобильном приложении.
        </span>
        <br />
        <br />
        <span>
        ...
        <ul>
          ...
          <br />
          <li>
            Баллы становятся активными и доступными к списанию на следующий день
